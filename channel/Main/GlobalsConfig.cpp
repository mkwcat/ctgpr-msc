...
void SetupGlobals([[maybe_unused]] int fst_expand)
{
    ...
    os0->info.console_type = 0x23;
    os0->info.arena_low = 0x80000000;
    os0->info.arena_high = 0x81800000;
    os0->info.fst = (char*)0x81800000;
    os0->info.fst_size = 0;
    ...
    *(u32*)0x80000100 = 0x4C000064;
    *(u32*)0x80000200 = 0x4C000064;
    *(u32*)0x80000300 = 0x4C000064;
    *(u32*)0x80000400 = 0x4C000064;
    *(u32*)0x80000500 = 0x4C000064;
    *(u32*)0x80000600 = 0x4C000064;
    *(u32*)0x80000700 = 0x4C000064;
    *(u32*)0x80000800 = 0x4C000064;
    *(u32*)0x80000900 = 0x4C000064;
    *(u32*)0x80000D00 = 0x4C000064;
    *(u32*)0x80000F00 = 0x4C000064;
    *(u32*)0x80001300 = 0x4C000064;
    *(u32*)0x80001400 = 0x4C000064;
    *(u32*)0x80001700 = 0x4C000064;

    DCFlushRange(os0, 0x3f00);

    *(u32*)0x80000C00 = 0x4C000064;
    *(u32*)0xC0000C00 = 0x4C000064;
}
